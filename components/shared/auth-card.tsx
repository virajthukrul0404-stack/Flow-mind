    ...
    <Card className="w-full max-w-md border border-white/80 bg-white/90">
      <CardContent className="p-8">
        ...
        <div className="space-y-4 rounded-3xl border border-slate-200 bg-slate-50 p-5 text-sm text-slate-600">
          ...
          <p>
            {isSignup
              ? "Use your Google account to create your FlowMind workspace instantly. No separate password is required."
              : "Use your Google account to sign in and return straight to your dashboard."}
          </p>
          <p>
